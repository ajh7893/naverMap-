...
function openNewWindow(img) { var d = img.src; var w = window.open("","_blank","width=1200, height=800, scrollbars=yes"); w.document.write("<p>IE브라우저 보안 정책으로 인해 직접 다운로드를 할수 없습니다. <br/>이미지를 마우스로 우클릭 해서 '다른 이름으로 사진 저장' 메뉴를 선택해 주세요.</p><img src='"+d+"' alt='from canvas'/>"); }
